        ...
        >
            ...
            <div className="relative z-10 flex flex-col justify-center h-full min-h-screen px-6 md:px-16 lg:px-24 pt-24 pb-24">
                <div className="max-w-xl">
                    ...
                    <h1
                        className={`${fadeUp('500ms').className} text-4xl md:text-6xl font-extrabold text-[#11B5F5] leading-tight mb-4 tracking-tight`}
                    ...
                    >
                        Indri Collection adalah usaha konveksi pemberdayaan disabilitas di Malang, menghasilkan ragam pakaian dengan <span className="text-[#11B5F5] font-medium">kualitas jahitan premium</span> yang penuh ketelitian.
                    </p>
                    ...
                    >
                        <a 
                            href="#about" 
                            className="inline-flex items-center gap-2 bg-[#11B5F5] hover:-translate-y-1  hover:shadow-[#11B5F5]/30 border-2 border-transparent active:scale-95 text-white text-sm md:text-base font-bold px-8 py-3.5 rounded-full transition-all duration-300 shadow-lg"
                        >
                            Jelajahi Koleksi 
                        </a>
                    </div>
            ...
            >
                <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none" className="w-full h-16 md:h-20">
                    <path d="M0,40 C360,80 1080,0 1440,40 L1440,80 L0,80 Z" fill="#F5FCFF" />
                </svg>
            </div>
