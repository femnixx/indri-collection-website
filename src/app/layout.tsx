...
import LayoutClientProvider from "@/components/layout/LayoutContentWrapper";
...
export const metadata: Metadata = {
  ...
  keywords: [
    "konveksi malang", "pemberdayaan disabilitas", "gamis malang", "tunik", 
    "hijab", "Indri Collection", "jahitan", "permak baju malang", 
    "jahit baju malang", "weave for change", "konveksi murah malang"
  ],
  ...
  openGraph: {
    ...
    images: [{ url: "/about.webp", width: 1200, height: 630, alt: "Indri Collection Workshop" }],
    locale: "id_ID",
    type: "website",
  },
  twitter: {
    ...
    description: "Usaha konveksi pemberdayaan disabilitas di Malang dengan kualitas jahitan premium.",
    images: ["/about.webp"],
  },
